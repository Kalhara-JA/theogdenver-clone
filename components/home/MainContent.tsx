  ...
  <div className="site-content">
    <main className="site-content__main page-id--614001">
      ...
      <section
        ...
        className="hero hero--scrollable hero--fullheight revealable"
      ...
      <section className="c-split c-split--vcenter revealable">
      ...
      <section
        className="c-tout-overlay revealable"
        style={{
          backgroundImage:
            "url('images/900500268-From-the-Hip-Photo388a.jpg?w=1200&fit=crop&auto=compress,format&crop=focalpoint&fp-x=0.5&fp-y=0.5')",
          backgroundPosition: '50.0% 50.0%',
        }}
      ></section>
      <section className="c-one-col--text content container revealable">
